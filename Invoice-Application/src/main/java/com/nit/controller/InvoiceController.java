...
import com.nit.service.IInvoiceService;
...
public class InvoiceController {
	...
	{
		Invoice invoiceObj = service.saveInvoice(invoice);
		Long id=invoiceObj.getId();
		String message="Invoice with id : "+id+" saved successfully.";
...
//		System.out.println(invoices);
	...
	@GetMapping("/edit")
    public String getEditPage(Model model,RedirectAttributes attributes,@RequestParam(name="id") Long id) {
       String page = null; 
       try {
    ...
    @GetMapping("/delete")
    public String deleteInvoice(@RequestParam(name="id") Long id,RedirectAttributes attributes) {
        try {
